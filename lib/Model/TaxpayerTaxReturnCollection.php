...
class TaxpayerTaxReturnCollection implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $RCCPMModelName = 'TaxpayerTaxReturnCollection';
    
    protected static $RCCPMTypes = [
        'context' => 'string',
        'id' => 'string',
        'type' => 'string',
        'hydramember' => '\SatClientPhp\Client\Model\ResponseTaxReturn[]',
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling TaxpayerTaxReturnCollection., must be bigger than or equal to 0.');
        }
