...
class ResponseTaxpayerTaxComplianceCheckCollection implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $RCCPMModelName = 'responseTaxpayerTaxComplianceCheckCollection';
    
    protected static $RCCPMTypes = [
        'context' => 'string',
        'id' => 'string',
        'type' => 'string',
        'hydramember' => '\SatClientPhp\Client\Model\ResponseTaxComplianceCheck[]',
        'hydratotal_items' => 'int',
        'hydraview' => '\SatClientPhp\Client\Model\ResponseCredentialType',
        'hydrasearch' => '\SatClientPhp\Client\Model\ResponseHydraSearch'
    ];
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ResponseTaxpayerTaxComplianceCheckCollection., must be bigger than or equal to 0.');
        }
