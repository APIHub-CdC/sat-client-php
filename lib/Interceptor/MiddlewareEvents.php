...
namespace SatClientPhp\Client\Interceptor;
...
use \SatClientPhp\Client\Interceptor\KeyHandler;
use \SatClientPhp\Client\Interceptor\MyLogger;
use \SatClientPhp\Client\Model\Errors;
use \SatClientPhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\SatClientPhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \SatClientPhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \SatClientPhp\Client\Model\Errores(["errors" => [$error]]);
